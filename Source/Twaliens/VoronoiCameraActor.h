...
*/
	...
	UFUNCTION(BlueprintCallable)
		void UpdatingFOV(float DefaultFOV, float PassedFOV, USceneCaptureComponent2D* SCC);

	void ActivateWidget(bool ActivateSplitScreen);

	UFUNCTION(BlueprintCallable)
	void ActivateDynamicSplitScreen();
