...
void ATwalien::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("NextWeapon", IE_Pressed, this, &ATwalien::NextWeapon);
	PlayerInputComponent->BindAction("PreviousWeapon", IE_Pressed, this, &ATwalien::PreviousWeapon);
...
void ATwalien::NextWeapon()
{
	PlayerWeapon->ChangeWeapon(1);
}

void ATwalien::PreviousWeapon()
{
	PlayerWeapon->ChangeWeapon(-1);
}
