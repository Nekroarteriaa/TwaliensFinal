...
public:	
	...
	FORCEINLINE void ClearSpawnLocations() { RespawnLocation.Empty(); }
	FORCEINLINE void AddSpawnLocation(AActor * SpawnLocation) { RespawnLocation.Add(SpawnLocation); }
	FORCEINLINE void GetSpawnLocation(TArray<AActor*> & Location) const { Location = RespawnLocation; }
};
